...
class HDF5VLADataset:
    def __init__(self) -> None:
        ...
        LEROBOT_DIR = "/mnt/wangxiaofa/robot_dataset/lerobot-format/simpler_fractal"
        ...
        self.image_views = ["observation.images.primary"]
    ...
    def get_ortho6d_from_euler_angle(self, states, is_quat=False):
        new_states = []
    ...
    def parese_parquet_file_state_only(self, file_path):
        ...
        states = self.get_ortho6d_from_euler_angle(states, is_quat=True)
